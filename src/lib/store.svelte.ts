...
function createStore() {
	...
	function init(initial: Connection[], canPublish: boolean = true) {
...
export const store = createStore();import type { AppMode, ConnectionClickInfo, Connection, ConnectionFormData } from '$lib/types';
import type { Polygon } from 'geojson';
import { CATEGORY_LAYERS } from '$lib/mapConfig';
